...
public class CustomListener implements WebDriverEventListener {
	...
	public void beforeFindBy(By by, WebElement element, WebDriver driver) {
		System.out.println("Going to try to find the element by: " + by.toString());
	...
	public void onException(Throwable throwable, WebDriver driver) {
		if (throwable instanceof NoSuchElementException) {
			...
			try {
				...
				String location = "c:\\temp\\" + fileName;
				FileHandler.copy(f, new File(location));
				System.out.println("NoSuchElementException, Screenshot stored: " + location);
			} catch (IOException e){
				//Nothing to do
			}
		}
